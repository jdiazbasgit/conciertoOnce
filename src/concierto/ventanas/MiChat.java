...
public class MiChat extends JFrame {
	...
	public MiChat() {
		...
		GridBagConstraints gbc_Lnik = new GridBagConstraints(0, 0, 1, 1, 0, 10, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(0, 60, 0, 0), 0, 0);
		getContentPane().add(getLNick(), gbc_Lnik);

		GridBagConstraints gbc_Tnik = new GridBagConstraints(1, 0, 1, 1, 40, 10, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 20, 0, 0), 0, 0);
		getContentPane().add(getTNick(), gbc_Tnik);

		GridBagConstraints gbc_Bregistrar = new GridBagConstraints(2, 0, 1, 1, 30, 10, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(0, 20, 0, 40), 0, 0);
		getContentPane().add(this.getBRegistrar(), gbc_Bregistrar);

		// ===================== Zona Central: =============================

		GridBagConstraints gbc_Lusurarios = new GridBagConstraints(0, 1, 1, 1, 30, 1, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0);
		getContentPane().add(this.getLUsuarios(), gbc_Lusurarios);

		GridBagConstraints gbc_TAusurarios = new GridBagConstraints(0, 2, 1, 1, 0, 70, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0);
		getContentPane().add(this.getTaUsuarios(), gbc_TAusurarios);

		GridBagConstraints gbc_TAmensajes = new GridBagConstraints(1, 1, 3, 2, 0, 80, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(0, 20, 0, 0), 0, 0);
		getContentPane().add(this.getTaMensajes(), gbc_TAmensajes);

		// ===================== Zona Inferior: =============================

		GridBagConstraints gbc_Lmensaje = new GridBagConstraints(0, 3, 1, 1, 0, 10, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0);
		getContentPane().add(this.getLMensaje(), gbc_Lmensaje);

		GridBagConstraints gbc_Tmensaje = new GridBagConstraints(1, 3, 1, 1, 80, 10, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 20, 0, 0), 0, 0);
		getContentPane().add(this.getTMensaje(), gbc_Tmensaje);

		GridBagConstraints gbc_Benviar = new GridBagConstraints(2, 3, 1, 1, 10, 10, GridBagConstraints.WEST,
