...
public class HomeController {
	 ...
	 * home(ModelAndView modelAndView) { modelAndView.setViewName("home"); Login
	 * login= new Login(); login.setUsuario("federico");
	 * modelAndView.addObject("login", login); return modelAndView; }
	 */
