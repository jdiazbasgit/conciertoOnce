...
public class Chat extends Frame{
	...
	public Chat() {
		/*
		 * setPGlobal(new Panel()); setPSuperior(new Panel()); setPCentral(new Panel());
		 * setPInferior(new Panel()); setPCentralIzquierda(new Panel());
		 * setPCentralIzquierdaSuperior(new Panel()); setPCentralIzquierdaInferior(new
		 * Panel()); setLNick(new Label("NICK:")); setLUsuarios(new Label("USUARIOS"));
		 * setLMensaje(new Label("MENSAJE:")); setBEnviar(new Button("ENVIAR"));
		 * setBRegistrar(new Button("REGISTRAR")); setTNick(new TextField(20));
		 * setTMensaje(new TextField(80)); setTaMensajes(new TextArea());
		...
		GridBagConstraints gb1 = new GridBagConstraints(0, 0, 1,1,1,1, GridBagConstraints.NORTHEAST, GridBagConstraints.BOTH,
